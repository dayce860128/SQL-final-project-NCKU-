...
if(isset($_POST["action"])&&($_POST["action"]=="update")){
    $sql_query = "UPDATE 交換學校基本資料表 SET 校名=?,所在國家=? ,承辦人=?,承辦人電話=?,學校地址=? WHERE 交換學校ID=?";
    $stmt = $db_link -> prepare($sql_query);
    $stmt -> bind_param("sssssi",$_POST["校名"],$_POST["所在國家"],$_POST["承辦人"],$_POST["承辦人電話"],$_POST["學校地址"],$_POST["交換學校ID"]);
    $stmt -> execute();
    $stmt -> close();
    $db_link -> close();
    ...
    <table border="1" aligin="center" cellpadding="4">
       ...
       <tr>
        ...
        <tr>
            ...
            <input name="交換學校ID" type="hidden" value="<?php echo $交換學校ID;?>">
            <input name="action" type="hidden" value="update">
            <input type="submit" type="button" value="更新資料">
